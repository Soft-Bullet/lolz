...
#define MIN_FREQ_LIMIT		288000
#define MIN_TOUCH_LIMIT_SECOND 288000
#define MIN_TOUCH_LIMIT		288000
#define MIN_TOUCH_LIMIT_SECOND_9LEVEL	MIN_TOUCH_LIMIT
#define MAX_UNICPU_LIMIT	2496000
#define MIN_SENSOR_LIMIT	288000
#if defined(CONFIG_SEC_GNOTE_PROJECT) || defined(CONFIG_SEC_HESTIA_PROJECT) || defined(CONFIG_SEC_RUBENS_PROJECT)
#define MIN_TOUCH_LOW_LIMIT     288000
#define MIN_TOUCH_HIGH_LIMIT	288000
#endif
...
#define MIN_TOUCH_LIMIT			288000
#define MIN_TOUCH_LIMIT_SECOND		288000
#define MIN_TOUCH_LIMIT_SECOND_9LEVEL	288000
#else
#define MIN_TOUCH_LIMIT		288000
#define MIN_TOUCH_LIMIT_SECOND		288000
#define MIN_TOUCH_LIMIT_SECOND_9LEVEL	MIN_TOUCH_LIMIT
#endif
#define MIN_TOUCH_HIGH_LIMIT	288000
#define MIN_CAMERA_LIMIT    288000
#endif
enum {
	DVFS_NO_ID			= 0,
