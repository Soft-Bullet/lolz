...
#define LAZYPLUG_MINOR_VERSION	2u
...
static unsigned int __read_mostly *nr_run_profiles[] = {
	...
	nr_run_thresholds_performance,  /* 1 */
	nr_run_thresholds_conservative, /* 2 */
	nr_run_thresholds_eco,          /* 3 */
	nr_run_thresholds_eco_extreme,  /* 4 */
	nr_run_thresholds_disable,      /* 5 */
